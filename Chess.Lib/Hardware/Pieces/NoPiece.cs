...
namespace Chess.Lib.Hardware.Pieces
{
	...
	internal record struct NoPawn : IPawn
	{
	...
	internal record struct NoKing(PieceType Type, Hue Side, IBoard Board, ISquare Square) : IKing
	{
