...
{
	public record struct ParseIntermediate(IParseableMove Move, IChessBoard Board, IParseResult Result);
		...
		IMoveParserEx
	{
		...
		/// <summary>
		/// Diagnostic method, useful for investigating failed PGN.
		/// </summary>
			...
			for (int i = 0; i < MoveList.Count; i++)
			{
				...
				switch (result)
				{
					case IParseSuccess s:
						...
						break;
					case IParseError e: return new ParseGameFail(makeResults(), e, game, remainingMoves());
